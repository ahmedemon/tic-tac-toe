...
function boxFunction() {
	...
	if ((box1 == 'x' || box1 == 'X') && (box2 == 'x' ||
		...
		document.getElementById('print').innerHTML = "<div class='p-1 border bg-success text-white text-center'>Player X Won</div>";
	...
	// not and after that disabled all the other fields
		...
		document.getElementById('print').innerHTML = "<div class='p-1 border bg-success text-white text-center'>Player 0 Won</div>";
		document.getElementById("box4").disabled = true;
		document.getElementById("box5").disabled = true;
		document.getElementById("box6").disabled = true;
		document.getElementById("box7").disabled = true;
	...
	// Here, Checking about Tie
		...
		document.getElementById('print').innerHTML = "<div class='p-1 border bg-info text-white text-center'>Match Tie</div>";
        Swal.fire(
            'Match Tie!',
            'This match is tie.',
            'info'
		...
		if (flag == 1) {
			document.getElementById('print').innerHTML = "<div class='p-1 border text-center'>Player X Turn</div>";
		}
		else {
			document.getElementById('print').innerHTML = "<div class='p-1 border text-center'>Player 0 Turn</div>";
		}
	}
}

// Function to reset game
function boxFunction_2() {
	location.reload();
